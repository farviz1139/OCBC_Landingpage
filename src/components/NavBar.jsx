  ...
  return (
    <div className="bg-white text-black border-b border-black">
      <div className="flex justify-between w-full px-5 py-5 ">
        ...
        <div>
          <button className="px-4 py-2 border border-black rounded cursor-pointer bg-purple-500 text-white mr-10" onClick={() => navigate('/weatherdata')}>Weather Data</button>
          <button className="px-4 py-2 border border-black rounded cursor-pointer bg-black text-white mr-10" onClick={() => navigate('/login')}>Login</button>
